package lab4_task4_ZonedDateTime;
...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
        /**
         * Create a {@link ZonedDateTime} with time
         * of 2015-07-10 2:14:25.000 as Japan Standard Time
         * by using {@link ZonedDateTime#of} and
         * {@link ZoneId#of}
         */
        LocalDate date=LocalDate.of(2015,7,10);
        LocalTime time=LocalTime.of(2,14,25);
        return ZonedDateTime.of(date,time,ZoneId.of("Asia/Tokyo"));
    }

    static ZonedDateTime zonedDateTimeParse() {
        /**
         * Create a {@link ZonedDateTime} with time
         * of 2015-06-18 23:07:25.000 as Japan Standard Time
    ...
    static String zonedDateTimeFormat() {
        ...
        /**
         * Format {@link zdt} to a {@link String}
         * as "2015_06_18_23_07_30_JST"
    ...
    static ZonedDateTime toPST() {
        ...
        /**
         * Create a {@link ZonedDateTime} from
         * {@link ldt} with Pacific Standard Time
         */
    ...
    static ZonedDateTime sameInstantAs() {
        ZonedDateTime zdt = DateAndTimes.ZDT_20150618_23073050;
        /**
         * Create a {@link ZonedDateTime} same
         * instant as {@link zdt} with Pacific Standard Time
    ...
    static ZonedDateTime sameLocalAs() {
        ZonedDateTime zdt = DateAndTimes.ZDT_20150618_23073050;
        /**
         * Create a {@link ZonedDateTime} same local
         * time as {@link zdt} with Pacific Standard Time
