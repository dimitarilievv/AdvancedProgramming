package lab4_task2_LocalDateTime;
...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeOf() {
        /**
         * Create a {@link LocalDateTime} of 2015-06-20 23:07:30
         * by using {@link LocalDateTime#of}
         */
        LocalDateTime ld=LocalDateTime.of(2015,6,20,23,7,30);
        return ld;
    }
    ...
    static LocalDateTime localDateTimeParse() {
        /**
         * Create a {@link LocalDateTime} of 2015-06-20 23:07:30
         * by using {@link LocalDateTime#parse}
         */
    ...
    static LocalDateTime localTimeWith() {
         ...
         * with first day of the next month and
         * also truncated to hours.
         */
    ...
    static LocalDateTime localDatePlusMinus() {
        ...
        /**
         * Create a {@link LocalDateTime} from {@link ldt}
         * with 10 month later and 5 hours before
         * by using {@link LocalDateTime#plus*} or
    ...
    static String localDateTimeFormat() {
        ...
        /**
         * Format {@link ldt} to a {@link String} as
         * "2015_06_18_23_07_30"
         * by using {@link LocalDateTime#format} and
    ...
    static String toLocalDateAndTime() {
        ...
        /**
         * Create a {@link LocalDate} and a
         * {@link LocalTime} from {@link ldt}
         * by using {@link LocalDateTime#toLocalDate}
         * and {@link LocalDateTime#toLocalTime}
         */
    ...
    static String toLocalDateTime() {
        ...
        /**
         * Create two equal {@link LocalDateTime}
         * from {@link ld} and {@link lt}
         * by using {@link LocalDate#atTime} and
         * {@link LocalTime#atDate}
         */
