package lab4_task3_LocalTime;

// package LocalTimeAPI;
...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToMinute() {
        /**
         * Create a {@link LocalTime} of 23:07
         * by using {@link LocalTime#of}
         */
    ...
    static LocalTime localTimeOfHourToNanoSec() {
        /**
         * Create a {@link LocalTime} of 23:07:03.1
         * by using {@link LocalTime#of}
         */
    ...
    static LocalTime localTimeParse() {
        /**
         * Create a {@link LocalTime} of 23:07:03.1
         * from String by using {@link LocalTime#parse}
         */
    ...
    static LocalTime localTimeWith() {
        ...
        /**
         * Create a {@link LocalTime} from {@link lt}
         * with hour 21
         * by using {@link LocalTime#withHour} or
         * {@link LocalTime#with}
         */
    ...
    static LocalTime localTimePlus() {
        ...
        /**
         * Create a {@link LocalTime} from {@link lt}
         * with 30 minutes later
         * by using {@link LocalTime#plusMinutes} or
         * {@link LocalTime#plus}
         */
    ...
    static LocalTime localTimeMinus() {
        ...
        /**
         * Create a {@link LocalTime} from
         * {@link lt} with 3 hours before
         * by using {@link LocalTime#minusHours} or
    ...
    static LocalTime localTimeMinusDuration() {
        ...
        /**
         * Define a {@link Duration} of 3 hours 30 minutes
         * and 20.2 seconds
         * Create a {@link LocalTime} subtracting the
         * duration from {@link lt} by using
         * {@link LocalTime#minus}
         */
        Duration d=Duration.ZERO.plusHours(3)
                .plusMinutes(30)
                .plusSeconds(20)
                .plusNanos((int)2E8);
    ...
    static boolean localDateIsBefore() {
        ...
        /**
         * Check whether {@link lt2} is before
         * {@link lt} or not
         * by using {@link LocalTime#isAfter} or
         * {@link LocalTime#isBefore}
         */
    ...
    static LocalTime localTimeTruncatedTo() {
        ...
        /**
         * Create a {@link LocalTime} from
         * {@link lt} truncated to minutes by using
