...
//    private static void readTask(String[] parts, List<Task> taskList, String kategorija, String ime, String opis) {
//        if (parts.length == 5) {
//            LocalDateTime rok = LocalDateTime.parse(parts[3]);
//            int prioritet = Integer.parseInt(parts[4]);
//            try {
//                taskList.add(new Task(kategorija, ime, opis, rok, prioritet));
//            } catch (DeadlineNotValidException e) {
//                out.println(e.getMessage());
//            }
//        } else if (parts.length == 4) {
//            if (parts[3].length() == 1) {
//                int prioritet = Integer.parseInt(parts[3]);
//                taskList.add(new Task(kategorija, ime, opis, prioritet));
//            } else {
//                LocalDateTime rok = LocalDateTime.parse(parts[3]);
//                try {
//                    taskList.add(new Task(kategorija, ime, opis, rok));
//                } catch (DeadlineNotValidException e) {
//                    out.println(e.getMessage());
//                }
//            }
//        } else if (parts.length == 3) {
//            taskList.add(new Task(kategorija, ime, opis));
//        }
//    }